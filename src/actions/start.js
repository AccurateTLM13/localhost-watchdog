...
function createStartManager(options = {}) {
  ...
  async function startProject(input = {}) {
    ...
    let launchResult;
    try {
      launchResult = await launcher({ project, cwd: project.startCwd || project.path, command: project.startCommand, args: project.startArgs || [], env: project.env, preferredPort: project.preferredPort, selectedPort, actionRequestId });
    } catch {
...
module.exports = { createStartManager, defaultProjectLauncherUnavailable, findRunningProject, nextAvailablePort };
